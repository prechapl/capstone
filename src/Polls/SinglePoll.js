...
class SinglePoll extends React.Component {
  ...
  render() {
    ...
    if (poll.status === 'open' && usersWithVotes.includes(this.state.userId)) {
      return <OpenPoll pollId={this.state.pollId} />;
    } else if (poll.status === 'closed') {
      return <ClosedPoll pollId={this.state.pollId} />;
    } else {
      return <VotePoll pollId={this.state.pollId} />;
    }
  }
}
