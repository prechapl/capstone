        ...
        return (
            <KeyboardAvoidingView behavior="padding" style={styles.container}>
                ...
                <Picker
                    ...
                    <Picker.Item label="chore" value="chore" style={{ backgroundColor: colorMap.chore }} />
                    <Picker.Item label="appointment" value="appointment" style={{ backgroundColor: colorMap.appointment }} />
                    <Picker.Item label="errand" value="errand" style={{ backgroundColor: colorMap.errand }} />
                </Picker>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => this.save()}
